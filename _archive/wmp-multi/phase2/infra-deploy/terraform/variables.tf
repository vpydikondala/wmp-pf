...
variable "meraki_poll_paths" {
  description = "Comma-separated Meraki API paths polled by the dashboard_sync service."
  type        = string
  default     = "/organizations"
}

variable "meraki_poll_interval_seconds" {
  description = "Dashboard Sync polling interval."
  type        = number
  default     = 300
}
