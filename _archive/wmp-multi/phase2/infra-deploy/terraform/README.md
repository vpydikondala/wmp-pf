...
- Application services: inbound and processor on ECS Fargate. The historical dashboard_sync service is disabled by default.
- Meraki API dashboard_sync access: Processor subnets -> NAT Gateway/EIP. APP/inbound subnets have no default Internet route.
