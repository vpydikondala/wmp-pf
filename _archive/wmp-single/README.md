...
is not committed to Git. This `single-account` variant uses one S3 bucket with separate object keys for legacy, Phase-2 infrastructure and Phase-2 application states.
